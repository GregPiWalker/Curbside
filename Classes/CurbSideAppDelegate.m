...
#import "CurbSideAppDelegate.h"

@implementation CurbSideAppDelegate
...
-(BOOL) application: (UIApplication *)application didFinishLaunchingWithOptions: (NSDictionary *)launchOptions {    
    // The NavigationController already instantiated the MainView.  Just set the main view's title.
    mainViewController.title = @"Curbside";
...
//        
//        [[ApplicationSupervisor instance] importDataFromUrl: url];
//    }
...
-(BOOL) application: (UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
    if ([url isFileURL]) {
        return [[ApplicationSupervisor instance] importDataFromUrl: url];
    }
    return NO;
}
...
- (void)applicationDidReceiveMemoryWarning:(UIApplication *)application {
     ...
     */
    //TODO:
    //[[ApplicationSupervisor instance] unloadData];
}
...
- (void)dealloc {
    ...
    [window release];
    //[[ApplicationSupervisor instance] dealloc];
    [super dealloc];
}
